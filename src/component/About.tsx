  ...
  return (
    ...
    <Tag text="About Me" icon={<VscSparkleFilled />} />
      ...
      <div className="grid grid-cols-2 gap-4 justify-center align-center">
        <div className="card border border-1 border-[#d1d5e0] rounded-[1.25rem] text-center dark:border-[#d1d1cf80] p-5">
      ...
      <div className="flex gap-2">
        ...
        <div className="info">
            <div className="card">
                ...
                <h4 className="detail">{personalInfo.name}</h4>
            </div>
            <div className="card">
                <p className="label">Phone</p>
                <h4 className="detail">{personalInfo.number}</h4>
            </div>
            <div className="card">
                <p className="label">Email</p>
                <h4 className="detail">{personalInfo.email}</h4>
            </div>
            <div className="card">
                <p className="label">Location</p>
                <h4 className="detail">{personalInfo.address}</h4>
            </div>
        </div>
      </div>
