            ...
            <nav className="main flex md:justify-between items-center justify-center gap-3">
                <div className="navlinks-main flex items-center">
                    <ul className="navlinks flex gap-3">
                        <li className="navlink  md:backdrop-blur-[4px] md:bg-[#e6ebf408] dark:bg-[#00000000] dark:md:bg-[#00000008] cursor-pointer md:border border-1 border-[#ffffff4d] rounded-[1.25rem] text-[#717586] min-w-[20px] md:px-5 md:py-2 "><a href="#" className=" whitespace-nowrap  flex items-center"><GrHomeRounded className=" d-md-none w-full h-full text-[20px] md:text-2xl" /><span className="d-lg-none">Home</span></a></li>
                        <li className="navlink  md:backdrop-blur-[4px] md:bg-[#e6ebf408] dark:bg-[#00000000] dark:md:bg-[#00000008] cursor-pointer md:border border-1 border-[#ffffff4d] rounded-[1.25rem] text-[#717586] min-w-[20px] md:px-5 md:py-2 "><a href="#" className=" whitespace-nowrap  flex items-center"><HiOutlineSquares2X2 className=" d-md-none w-full h-full text-[20px] md:text-2xl" /><span className="d-lg-none">Portfolio</span></a></li>
                        <li className="navlink  md:backdrop-blur-[4px] md:bg-[#e6ebf408] dark:bg-[#00000000] dark:md:bg-[#00000008] cursor-pointer md:border border-1 border-[#ffffff4d] rounded-[1.25rem] text-[#717586] min-w-[20px] md:px-5 md:py-2 "><a href="#" className=" whitespace-nowrap  flex items-center"><AiOutlineUser className=" d-md-none w-full h-full text-[20px] md:text-2xl" /><span className="d-lg-none">About Me</span></a></li>
                        <li className="navlink  md:backdrop-blur-[4px] md:bg-[#e6ebf408] dark:bg-[#00000000] dark:md:bg-[#00000008] cursor-pointer md:border border-1 border-[#ffffff4d] rounded-[1.25rem] text-[#717586] min-w-[20px] md:px-5 md:py-2 "><a href="#" className=" whitespace-nowrap  flex items-center"><LuSquareMenu className=" d-md-none w-full h-full text-[20px] md:text-2xl" /><span className="d-lg-none">Resume</span></a></li>
                        <li className="navlink  md:backdrop-blur-[4px] md:bg-[#e6ebf408] dark:bg-[#00000000] dark:md:bg-[#00000008] cursor-pointer md:border border-1 border-[#ffffff4d] rounded-[1.25rem] text-[#717586] min-w-[20px] md:px-5 md:py-2 "><a href="#" className=" whitespace-nowrap  flex items-center"><FaRegEnvelope className=" d-md-none w-full h-full text-[20px] md:text-2xl" /><span className="d-lg-none">Contact</span></a></li>
                    </ul>
                </div>
